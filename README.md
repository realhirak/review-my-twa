...
```html
<script src="https://cdn.jsdelivr.net/npm/review-my-twa@1.0.14/dist/review-my-twa.min.js"></script>
```
...
| Version         | URL                                                                          |
| --------------- | ---------------------------------------------------------------------------- |
| Latest (v1.0.14) | `https://cdn.jsdelivr.net/npm/review-my-twa@1.0.14/dist/review-my-twa.min.js` |
