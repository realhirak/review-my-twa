...
```html
<script src="https://cdn.jsdelivr.net/npm/review-my-twa@1.0.2/dist/review-my-pwa.min.js"></script>
```
...
| Version         | URL                                                                          |
| --------------- | ---------------------------------------------------------------------------- |
| Latest (v1.0.2) | `https://cdn.jsdelivr.net/npm/review-my-twa@1.0.2/dist/review-my-pwa.min.js` |
